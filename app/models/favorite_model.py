...
class Favorite(Base):
    ...
    favorite_user = relationship("User", back_populates="user_favorite", lazy="joined")
    favorite_mediafile = relationship("Mediafile", back_populates="mediafile_favorite", lazy="joined")
